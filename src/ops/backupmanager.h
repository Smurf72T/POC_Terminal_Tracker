...
public:
    ...
    static BackupResult createBackup(const QSqlDatabase& db, const QString& filePath, const QString& connectionPassword,
                                     const QString& passphrase, std::atomic<bool>* cancelRequested = nullptr);
    ...
    static bool restoreDatabase(const QSqlDatabase& db, const QString& filePath, const QString& connectionPassword,
                                const QString& passphrase, QString* error = nullptr,
