...
- **Массовое обновление статусов:** Множественный выбор терминалов для смены статуса
- **Отчёты по периодам:** Выручка по клиентам, загрузка терминалов, конвертация аренды, использование SIM-карт
